...
def get_orientation_data( xdatcar_filenames, orientation_params=None, verbose=False ):
    if verbose:
        print( 'Initialising' )
...
def save_orientation_data( output, system, orientation_data ):
    #TODO
...
if __name__ == '__main__':
    args = parse_args()
    if args.verbose:
        print( 'Vertex orientation calculation for {}'.format(args.system) )
    orientation_params = {}
    xdatcar_filenames = [ '{}/{}/run{}/inherent_XDATCAR.gz'.format( args.data, args.system, i ) for i in args.nruns ]
    orientation_data = get_orientations( xdatcar_filenames, 
                                         orientation_params=orientation_params,
                                         verbose=args.verbose )
    save_orientation_data( args.output, args.system, orientation_data )
